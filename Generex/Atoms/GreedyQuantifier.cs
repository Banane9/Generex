...
{
    public class GreedyQuantifier<T> : UnaryModifier<T>
    {
        public int Maximum { get; }
        public int Minimum { get; }

        public GreedyQuantifier(Generex<T> atom, int minimum, int maximum) : base(atom)
        {
            if (minimum < 0)
        ...
        public GreedyQuantifier(Generex<T> atom, int exactly) : this(atom, exactly, exactly)
        { }
